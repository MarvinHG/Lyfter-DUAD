...
from actions import Student, get_basic_student_info, get_student_grades, get_all_students_formatted, calculate_general_average, get_top_3_students_formatted, get_student, get_failed_students_formatted, delete_student
...
def menu_1_fill_student_info(students):
    ...
    while True:
        ...
        student = Student(
            ...
            basic_info["section"],
            grades["spanish_grade"],
            grades["english_grade"],
            grades["social_studies_grade"],
            grades["science_grade"]
        )
